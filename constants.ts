...
export const PROGRAMMING_LANGUAGES: import('./types').ProgrammingLanguage[] = [
  // Languages
  { name: "Assembly", icon: "si si-assemblyscript", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Languages" },
  ...
  { name: "Fortran", icon: "devicon-fortran-original", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Languages" },
  ...
  { name: "PyScript", icon: "devicon-python-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Frameworks & Libraries" },
  ...
  { name: "Keras", icon: "devicon-keras-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Frameworks & Libraries" },
  ...
  { name: "Seaborn", icon: "devicon-python-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Frameworks & Libraries" },
  { name: "TensorBoard", icon: "devicon-tensorflow-original", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Frameworks & Libraries" },
  ...
  { name: "TeX", icon: "si si-latex", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  ...
  { name: "npm", icon: "devicon-npm-original-wordmark", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  { name: "Anaconda", icon: "devicon-anaconda-original", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  ...
  { name: "cPanel", icon: "devicon-cpanel-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  { name: "SSH", icon: "devicon-ssh-original", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  { name: "Notion", icon: "devicon-notion-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  { name: "Slack", icon: "devicon-slack-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },
  { name: "Trello", icon: "devicon-trello-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Tools & Platforms" },

  // Operating Systems
  { name: "Windows 7", icon: "devicon-windows8-original", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Operating Systems" },
  ...
  { name: "Debian", icon: "devicon-debian-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Operating Systems" },
  ...
  { name: "Artix Linux", icon: "devicon-artixlinux-plain", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "CentOS", icon: "devicon-centos-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Operating Systems" },
  { name: "Red Hat", icon: "devicon-redhat-plain", color: "#00f0ff", glowColor: "rgba(0, 240, 255, 0.5)", category: "Operating Systems" },
  { name: "Linux Mint", icon: "devicon-linuxmint-plain", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "AlmaLinux", icon: "devicon-almalinux-plain", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "NixOS", icon: "devicon-nixos-plain", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "openSUSE", icon: "devicon-opensuse-original", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "Gentoo Linux", icon: "devicon-gentoo-plain", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
  { name: "Rocky Linux", icon: "devicon-rockylinux-original", color: "#00f0ff", glowColor: "rgba(0,240,255,0.5)", category: "Operating Systems" },
