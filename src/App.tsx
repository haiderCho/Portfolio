...
// Existing component imports (will be gradually moved to features)
...
const AppContent = () => {
  ...
  const { data: techStack = [] } = useSkills();
    ...
    return (
      <div className="h-screen w-full bg-[var(--color-cyber-black)] flex flex-col items-center justify-center font-mono text-[var(--color-cyber-primary)] p-4 transition-colors duration-300">
        ...
        <div className="mt-2 text-xs text-[var(--color-cyber-muted)]">
          LOADING MODULES: [ REACT, TAILWIND, D3, FSD ]
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:flex gap-1 xl:gap-2">
              <NavItem id="home" label={themeConfig.navLabels.home} />
              <NavItem id="experience" label={themeConfig.navLabels.experience} />
              <NavItem id="education" label={themeConfig.navLabels.education} />
              <NavItem id="skills" label={themeConfig.navLabels.skills} />
              <NavItem id="projects" label={themeConfig.navLabels.projects} />
              <NavItem id="about" label={themeConfig.navLabels.about} />
              <NavItem id="contact" label={themeConfig.navLabels.contact} />
            </div>
            <ThemeSwitcher />
          </div>
        </div>
