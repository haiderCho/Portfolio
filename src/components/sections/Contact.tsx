...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-8 px-6 bg-cyber-black border-t border-cyber-dim relative overflow-hidden"
    >
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="text-2xl font-bold mb-4 glitch-text text-[var(--color-cyber-text)]">
          {themeConfig.sectionTitles.contact}
        </h2>
        ...
        <div className="flex justify-center gap-6">
          <a
            ...
            className="p-3 rounded-full bg-cyber-panel border border-cyber-dim hover:border-cyber-primary hover:text-cyber-primary active:border-cyber-primary active:text-cyber-primary transition-all"
          >
